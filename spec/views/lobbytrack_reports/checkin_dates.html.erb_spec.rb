...
RSpec.describe 'lobbytrack_reports/checkin_dates.html.erb', type: :view do
  ...
  describe 'visits result page' do
    it 'displays a header with some info about the report' do
      assert_select 'h1', text: 'Visitor check-ins by date range:', count: 1
      assert_select 'h2', text: '2 Checkins', count: 1
    end
