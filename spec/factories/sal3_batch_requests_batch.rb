...
FactoryBot.define do
  ...
  factory :sal3_batch_requests_batch_invalid_file, class: Sal3BatchRequestsBatch do
    batch_id { 1 }
    batch_name { 'Batch name' }
    user_name { 'Test User' }
    user_email { 'libraryuser@stanford.edu, otheruser@stanford.edu' }
    ...
    comments { 'Test comment' }
    ckey { '1234567' }
    bc_file { Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/files/test_file.xlsx')) }
    num_bcs { '' }
    num_nonsymph_bcs { '' }
    pending { '' }
    load_date { '14-06-16' }
