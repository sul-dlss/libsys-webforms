...
class CirculationStatisticsReportLog < ApplicationRecord
  ...
  def self.other_params(circ_stats)
    { email: circ_stats.email, selcall_src: circ_stats.source,
      ...
      exclude_bad_year: circ_stats.exclude_bad_yr,
      summary_only: circ_stats.no_qtrly,
      ckey_url: circ_stats.ckey_url,
      extras_url: circ_stats.tags_url,
      include_inhouse: circ_stats.include_inhouse,
      min_pub_year: circ_stats.min_yr,
      max_pub_year: circ_stats.max_yr,
      extra_field: circ_stats.tag_field,
      extra_field2: circ_stats.tag_field2,
      extra_field3: circ_stats.tag_field3,
      extra_field4: circ_stats.tag_field4,
      link_type: circ_stats.link_type,
  ...
  def self.process_range_type_params(circ_stats)
    ...
    when 'barcodes'
      ...
      range_type_params['input_path'] = '/s/SUL/Dataload/Uploads/CircStats/' \
